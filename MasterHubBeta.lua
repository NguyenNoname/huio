...
local NotiFrame = Instance.new("Frame")
	...
	DiscordLib:Notification("ThÃ´ng BÃ¡o" , "NhÃ¢Ì£n CaÌ€y ThuÃª BaÌn Acc v4 Ae NaÌ€o CÃ¢Ì€n IB" , 6 ,11816162894 )
	DiscordLib:Notification("ThÃ´ng BÃ¡o" , "Link Facebook Æ Ì‰ PhÃ¢Ì€n Setting " , 6 ,11816162894 )
...
spawn(function()
    while wait() do
        if _G.Auto_Farm_Level then
            ...
            elseif _G.Select_Mode_Farm == "Farm KhÃ´ng NhiÃªÌ£m VuÌ£" then
				pcall(function()
                	CheckQuest()
					if game:GetService("Workspace").Enemies:FindFirstChild(Ms) then
						for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
...
elseif _G.Select_Mode_Farm == "Farm GÃ¢Ì€n nhÃ¢Ìt" then
  for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
...
Setting:Label("HaÌƒy CaÌ€y ThuÃª")

Setting:Line()

Setting:Button("Sao CheÌp Link Facebook",function()
 
 setclipboard("https://www.facebook.com/asukanaken")
  DiscordLib:Notification("ThÃ´ng BÃ¡o" , "ÄaÌƒ Sao CheÌp Link Facebook" , 10 ,11816162894 )
 end)
...
spawn(function()
	while task.wait() do
		pcall(function()
			if _G.Auto_Farm_Level and _G.Select_Mode_Farm == "Farm GÃ¢Ì€n nhÃ¢Ìt" then
				for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
					if v.Name == Ms and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 350 then
						v.Humanoid.WalkSpeed = 0
						v.Humanoid.JumpPower = 0
...
Setting:Toggle("TaÌ€n HiÌ€nh QuaÌi",false,function(value)
    _G.inv = value
...
Setting:Toggle("Remove HiÃªÌ£u Æ¯Ìng chÃªÌt",true,function(value)
...
spawn(function()
    ...
    Setting:Toggle("Ã‚Ì‰n Gui",false,function(value)
        if value == true then
 ...
 Setting:Toggle("Fix lag nheÌ£",nil,function(value)
...
spawn(function()
 ...
 ca:Button("ChÃ´Ìƒ Mua ThuyÃªÌ€n ( Update )",function()
...
ca:Button("XoÌa XÆ°Æ¡ng MuÌ€",function()
...
ca:Toggle("TÄƒng TÃ´Ìc ÄÃ´Ì£ cho thuyÃªÌ€n", false, function(vSpeedBoat)
	...
	while task.wait() do
		pcall(function()
			if game.Workspace.Map:FindFirstChild("KitsuneIsland") then
				mr:Set("ðŸ Kitsune Island :  âœ…")
			else
				mr:Set("ðŸ Kitsune Island :  âŒ")
			end
		end)
	end
end) 
...
ca:Toggle("Bay vaÌ€o Ä‘aÌ‰o Kitsune ", false, function(value)
    _G.tpkit = value
    StopTween(_G.tpkit)
end)
...
ca:Toggle("Nháº·t Linh há»“n", false, function(value)
    ...
    if _G.lumlinhhon then
        -- Báº¯t Ä‘áº§u vÃ²ng láº·p náº¿u chá»©c nÄƒng Ä‘Æ°á»£c báº­t
        spawn(function()
            while _G.lumlinhhon do
                ...
                if humanoidRootPart then
                    ...
                    -- Kiá»ƒm tra sá»± tá»“n táº¡i cá»§a "Part" vÃ  nhÃ¢n váº­t
                    while not partFound and humanoidRootPart:IsDescendantOf(workspace) do
                        ...
                        wait(0.1) -- Chá» 0.3 giÃ¢y trÆ°á»›c khi kiá»ƒm tra láº¡i
                    end
                end
            end
        end)
...
ca:Button("Teleport Linh hÃ´Ì€n",function()
...
ca:Button("Trao ÄÃ´Ì‰i Linh HÃ´Ì€n",function()
game:GetService("ReplicatedStorage"):WaitForChild("Modules"):WaitForChild("Net"):WaitForChild("RF/KitsuneStatuePray"):InvokeServer()
 end)

Setting:Toggle("Click 0 GiÃ¢y",nil,function(value)
    local SuperFastMode1 = value -- à¹€à¸›à¸¥à¸µà¹ˆà¸¢à¸™à¹€à¸›à¹‡à¸™à¸ˆà¸£à¸´à¸‡à¸–à¹‰à¸²à¸„à¸¸à¸“à¸•à¹‰à¸­à¸‡à¸à¸²à¸£à¹‚à¸ˆà¸¡à¸•à¸µ Super Super Super Fast (à¹€à¸Šà¹ˆà¸™à¸à¸²à¸£à¸†à¹ˆà¸²à¸—à¸±à¸™à¸—à¸µ) à¹à¸•à¹ˆà¸ˆà¸°à¸—à¸³à¹ƒà¸«à¹‰à¹€à¸à¸¡à¹€à¸•à¸°à¸„à¸¸à¸“à¸¡à¸²à¸à¸à¸§à¹ˆà¸²à¹‚à¸«à¸¡à¸”à¸›à¸à¸•à¸´
             _G.aothatday1 = value
...
Setting:Toggle("MaÌ€n HiÌ€nh Treo Farm [ MÆ°Æ¡Ì£t HÆ¡n ]",_G.WhiteScreen,function(value)
 ...
 game:GetService("RunService"):Set3dRenderingEnabled(true)
   ...
   Setting:Button("GiaÌ‰m Lag",function()
	...
	function DiscordLib:Notification(text,text2,delays,logo)
      ...
      DiscordLib:Notification("ThÃ´ng BÃ¡o" , "BÃ¢Ì£t Xong SeÌƒ BiÌ£ ÄÆ°Ìng MaÌy 5-10 GiÃ¢y" , 10 ,11816162894 )
      wait(3)
...
Time:Set("[Sever ÄaÌƒ Treo] : GiÆ¡Ì€ : "..Hour.. "  PhuÌt : "..Minute.."  GiÃ¢y : "..Second)
end
...
local SelectWeapona = Main:Dropdown("ChoÌ£n Item Farm",WeaponList,function(value)
...
-- Láº¥y danh sÃ¡ch táº¥t cáº£ ngÆ°á»i chÆ¡i trong trÃ² chÆ¡i
if not game.Players.LocalPlayer.Character:FindFirstChild("HasBuso") then
  local args = {
   [1] = "Buso"
  }
...
local maxDistance = 400 -- Khoáº£ng cÃ¡ch tá»‘i Ä‘a Ä‘á»ƒ xem xÃ©t

    -- Äá»£i 1 giÃ¢y trÆ°á»›c má»—i láº§n cáº­p nháº­t
if not game.Players.LocalPlayer.Character:FindFirstChild("HasBuso") then
  local args = {
   [1] = "Buso"
  }
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
    ...
    if nearestPlayer then
        ...
        if targetHead then
            ...
            local newPosition = targetHead.Position - direction * 10,10,10,10 -- Äiá»u chá»‰nh khoáº£ng cÃ¡ch di chuyá»ƒn
...
Main:Dropdown("ChoÌ£n ChÃªÌ ÄÃ´Ì£ Farm", {
 "Farm Theo Lever","Farm speed","Farm KhÃ´ng NhiÃªÌ£m VuÌ£","Farm GÃ¢Ì€n nhÃ¢Ìt"
},function(value)
 _G.Select_Mode_Farm = value
end)

Main:Toggle("BÄƒÌt ÄÃ¢Ì€u Farm",_G.Auto_Farm_Level,function(value)
...
Main:Toggle("Auto Farm ChÃ¢Ìt KiÌ€ DiÌ£ ",_G.Auto_Farm_Ectoplasm,function(value)
 _G.Auto_Farm_Ectoplasm = value
 StopTween(_G.Auto_Farm_Ectoplasm)
 end)

Main:Seperator("NhaÌ€ MaÌy")

Main:Toggle("Auto Farm NhaÌ€ MaÌy",_G.AutoFactory,function(value)
...
Main:Seperator(" Farm theo muÌ£c ")

Main:Dropdown("ChoÌ£n QuaÌi Farm", tableMon, function(vu)
 SelectMonster = vu
 end)

Main:Toggle("Farm QuaÌi ÄÆ°Æ¡Ì£c ChoÌ£n",_G.AutoFarmSelectMonster,function(vu)
...
-- Main:Toggle("Auto Farm ThÃ´ng ThaÌ£o SuÌng",_G.AutoFarmGunMastery,function(value)
...
--if not game:GetService("UserInputService").TouchEnabled and not game:GetService("UserInputService").KeyboardEnabled == false then
--_G.Kill_At = 25
--Main:Slider("kill Theo % MaÌu CuÌ‰a QuaÌi",1,100,25,function(value)
 --_G.Kill_At = value
--end)
--else
--_G.Kill_At = 25
...
spawn(function()
			while task.wait() do
				if _G.BringNormal and _G.Select_Mode_Farm == "Farm GÃ¢Ì€n nhÃ¢Ìt" then
					pcall(function()
						for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
...
spawn(function()
    while wait() do
        pcall(function()
            BoneCheck:Set("Bones Äang CoÌ : "..(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Candy","Check")))
        end)
    end
end)
  ...
  if _G.Auto_Cake_Prince1 then
			pcall(function()
				...
				elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86 then
					...
					Mob_Kill_Cake_Prince:Set("Boss ÄaÌƒ ÄÆ°Æ¡Ì£c TriÃªÌ£u HÃ´Ì€i")
				end
			end)
   end
	end
...
StopTween(_G.Auto_Cake_Prince)
	...
	Main:Toggle("KiÃªÌm CuÌp Cacao + ÄaÌnh Katakuri V2",_G.Auto_Open_Dough_Dungeon,function(value)
...
StopTween(_G.Auto_Open_Dough_Dungeon)
	...
	Main:Seperator(" Farm NguyÃªn LiÃªÌ£u ")
	if World3 then
	Main:Toggle("Farm BÃ´Ì£t Cacoa",_G.Cacao,function(value)
 _G.Cacao = value
 _G.click = value
StopTween(_G.Cacao)
end)
...
spawn(function()
 ...
 pcall(function()
  ...
  topos(CFrame.new(378.500763, 78.9238205, -12511.4004, -0.980175495, -0.00775680691, -0.197979629, -7.71833584e-08, 0.999233365, -0.0391495228, 0.198131591, -0.0383733809, -0.97942394))
	...
	if World3 then
Main:Toggle("Farm VaÌ‰y RÃ´Ì€ng",_G.vayrong,function(value)
 _G.vayrong = value
 _G.click = value
...
spawn(function()
 ...
 pcall(function()
  ...
  topos(CFrame.new(6606.63965, 150.777206, -586.454468, 0.164548442, -0.0395196229, -0.985576928, -1.3015233e-07, 0.999197006, -0.0400657691, 0.986368954, 0.00659288513, 0.164416313))
	...
	if World3 then
	Main:Toggle("Farm ÄuÃ´i CaÌ",_G.duoica,function(value)
 _G.duoica = value
 _G.click = value
StopTween(_G.duoica)
end)
...
if World3 then
	Main:Toggle("Farm SÆ°Ì€ng TÃª GiaÌc + SÄƒÌt VuÌ£n + Da",_G.sungtegiac,function(value)
 _G.sungtegiac = value
 _G.click = value
...
if World3 then
Main:Toggle("Farm XÆ°Æ¡ng + QuÌ‰y HÃ´Ì€n",_G.Auto_Farm_Bone,function(value)
 _G.Auto_Farm_Bone = value
 _G.click = value
 StopTween(_G.Auto_Farm_Bone)
end)
...
if World3 then
Main:Toggle("Farm ThuÃ´Ìc SuÌng + SÄƒÌt VuÌ£n + Da",_G.thuocsung,function(value)
 _G.thuocsung = value
 _G.click = value
...
spawn(function()
    while wait() do
        pcall(function()
            candycheck:Set("Candies Äang CoÌ : "..(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Candies","Check")))
        end)
    end
end)    
Main:Toggle("Farm keÌ£o ( New )",_G.candy,function(value)
 _G.candy = value
 _G.click = value
 StopTween(_G.candy)
end)
end
Main:Toggle("ÄÃ´Ì‰i 100 candy LÃ¢Ìy 500 f",false,function(value)
...
if World2 then
Main:Toggle("Farm NÆ°Æ¡Ìc MÄƒÌt ThÃ¢Ì€n BiÌ",_G.nuocmat,function(value)
 _G.nuocmat = value
 _G.click = value
...
if World2 then
Main:Toggle("Farm QuÄƒÌ£ng Nham ThaÌ£ch",_G.magma,function(value)
 _G.magma = value
 _G.click = value
 StopTween(_G.magma)
end)
...
if World2 then
Main:Toggle("Farm ChÃ¢Ìt KiÌ€ DiÌ£ ",_G.Auto_Farm_Ectoplasm,function(value)
 _G.Auto_Farm_Ectoplasm = value
 StopTween(_G.Auto_Farm_Ectoplasm)
end)
end
...
if World2 then
Main:Toggle("Farm ChÃ¢Ìt PhoÌng XaÌ£ ",_G.chatpong,function(value)
 _G.chatpong = value
 _G.click = value
...
if World2 then
Main:Toggle("Farm SÄƒÌt VuÌ£n + Da ",_G.shinap,function(value)
 _G.shinapo = value
 _G.click = value
 StopTween(_G.shinap)
end)
...
-- Táº¡o label cho tá»«ng boss vÃ  theo dÃµi tráº¡ng thÃ¡i spawn
...
local refreshButton = Main:Button("LÃ m Má»›i Boss", function()
    BossName:Clear()
    local existingBosses = {}

    -- Kiá»ƒm tra xem boss nÃ o cÃ³ sáºµn vÃ  thÃªm vÃ o danh sÃ¡ch
...
Main:Toggle("Farm Boss ÄaÌƒ ChoÌ£n",_G.Auto_Farm_Boss,function(value)
 _G.Auto_Farm_Boss = value
 _G.click = value
 end)

Main:Toggle("NhÃ¢Ì£n NhiÃªÌ£m VuÌ£ Boss",true,function(value)
...
Weapon:Toggle("TÆ°Ì£ ÄÃ´Ì£ng Mua Haki MaÌ€u",_G.Auto_Buy_Enchancement,function(value)
 _G.Auto_Buy_Enchancement = value
StopTween(_G.Auto_Buy_Enchancement)
end)
Weapon:Toggle("TÆ°Ì£ ÄÃ´Ì£ng ÄaÌnh Sea Beasts",_G.SeaBeasts1,function(value)
 _G.SeaBeasts1 = value
...
local Elite_Hunter_Status = Weapon:Label("Status")
		...
		while wait() do
			pcall(function()
				if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
					Elite_Hunter_Status:Set("Status : ÄaÌƒ CoÌ Elite Hunter")	
				else
					Elite_Hunter_Status:Set("Status : ChÆ°a CoÌ Elite Hunter")	
				end
			end)
		end
	end)
	...
	Weapon:Toggle("TÆ°Ì£ ÄÃ´Ì£ng ÄaÌnh Elite Hunter",_G.Auto_Elite_Hunter,function(value)
...
StopTween(_G.Auto_Elite_Hunter)
	...
	Weapon:Toggle("ÄÃ´Ì‰i Sever ÄaÌnh Elite Hunter",_G.Auto_Elite_Hunter_Hop,function(value)
...
Weapon:Seperator("V2 + Ghoul ")		
	 ...
	 Weapon:Toggle("MuÌƒ ÄÃ¢Ìu TrÆ°Æ¡Ì€ng + TÃ´Ì£c V2",_G.mudautr,function(value)
 _G.mudautr = value
 StopTween(_G.mudautr)
end)

Weapon:Toggle("Auto ÄaÌnh Boss + ÄÃ´Ì‰i tÃ´Ì£c QuÌ‰y",_G.tocquyautr,function(value)
 _G.tocquy = value
 _G.click = value
 _G.FastAttack = false
...
Weapon:Toggle("TÆ°Ì£ ÄÃ´Ì£ng Mua KiÃªÌm Legendary",_G.AutoBuyLegendarySword,function(Value)
		...
		Weapon:Toggle("ÄÃ´Ì‰i Sever Mua KiÃªÌm Legendary",_G.AutoBuySwordHop,function(Value)
	...
	Weapon:Toggle("LÃ¢Ìy Rengoku",_G.Auto_Rengoku,function(value)
...
Weapon:Toggle("Quay XÆ°Æ¡ng ( TÆ°Ì£ TriÃªÌ£u HÃ´Ì€i VaÌ€ ÄaÌnh Boss )",_G.Auto_Soul_Reaper,function(value)
...
Weapon:Toggle("Qua Sever KhaÌc Quay XÆ°Æ¡ng",_G.Auto_Soul_Reaper_Hop,function(value)
...
StopTween(_G.Auto_Soul_Reaper_Hop)
	...
	Weapon:Toggle("TÆ°Ì£ ÄÃ´Ì£ng LÃ¢Ìy Yama",_G.Auto_Yama,function(value)
	 _G.Auto_Yama = value
	 _G.click = value
...
StopTween(_G.Auto_Rainbow_Haki_Hop)
	...
	Weapon:Toggle("TÆ°Ì£ ÄÃ´Ì£ng LÃ¢Ìy KiÃªÌm Canvander",_G.Auto_Canvander,function(value)
 _G.Auto_Canvander = value
StopTween(_G.Auto_Canvander)
end)

	
	Weapon:Toggle("ÄÃ´Ì‰i Sever LÃ¢Ìy KiÃªÌm Canvander",_G.Auto_Canvander_Hop,function(value)
...
StopTween(_G.Auto_Canvander_Hop)
	...
	Weapon:Toggle("LÃ¢Ìy KiÃªÌm Twin Hook",_G.Auto_Twin_Hook,function(value)
...
StopTween(_G.Auto_Twin_Hook)
	...
	Weapon:Toggle("ÄÃ´Ì‰i Sever LÃ¢Ìy KiÃªÌm Twin Hook",_G.Auto_Twin_Hook_Hop,function(value)
...
Weapon:Toggle("LÃ¢Ìy Cung Serpent Bow",_G.Auto_Serpent_Bow,function(value)
 _G.Auto_Serpent_Bow = value
StopTween(_G.Auto_Serpent_Bow)
end)

	
	Weapon:Toggle("ÄÃ´Ì‰i Sever LÃ¢Ìy Cung Serpent Bow",_G.Auto_Serpent_Bow_Hop,function(value)
...
Weapon:Toggle("TÆ°Ì£ ÄÃ´Ì£ng Kill Boss Tushita",_G.Autotushita,function(value)
...
Weapon:Toggle("TÆ°Ì£ ÄÃ´Ì£ng GÄƒÌn ÄuÃ´Ìc",_G.Auto_Holy_Torch,function(value)
...
Weapon:Seperator(" Haki quan sÃ¡t V2 ")

Weapon:Toggle("TÆ°Ì£ ÄÃ´Ì£ng LÃ¢Ìy Haki quan sÃ¡t V2",_G.AutoObservationHakiV2,function(x)
...
Weapon:Seperator(" MuÌƒ Phi CÃ´ng ")

Weapon:Toggle("LÃ¢Ìy MuÌƒ Phi CÃ´ng",_G.Auto_Musketeer_Hat,function(value)
...
Weapon:Toggle("LÃ¢Ìy Superhuman",_G.Auto_Superhuman,function(value)
 _G.Auto_Superhuman = value
end)


Weapon:Toggle("TÆ°Ì£ ÄÃ´Ì£ng LaÌ€m Nv Superhuman",_G.Auto_Fully_Superhuman,function(value)
...
Weapon:Toggle("LÃ¢Ìy Death Step",_G.Auto_Death_Step,function(value)
...
Weapon:Toggle("TÆ°Ì£ ÄÃ´Ì£ng LaÌ€m Nv  Death Step",_G.Auto_Fully_Death_Step,function(value)
...
Weapon:Toggle("TÆ°Ì£ ÄÃ´Ì£ng LÃ¢Ìy Sharkman Karate",_G.Auto_SharkMan_Karate,function(value)
...
Weapon:Toggle("TÆ°Ì£ ÄÃ´Ì£ng LaÌ€m Nv  Sharkman Karate",_G.Auto_Fully_SharkMan_Karate,function(value)
...
Weapon:Toggle("TÆ°Ì£ ÄÃ´Ì£ng LÃ¢Ìy Electric Claw",_G.Auto_Electric_Claw,function(value)
...
Weapon:Toggle("TÆ°Ì£ ÄÃ´Ì£ng LÃ¢Ìy Dragon Talon",_G.Auto_Dragon_Talon,function(value)
...
Weapon:Toggle("TÆ°Ì£ ÄÃ´Ì£ng LÃ¢Ìy God Human",_G.Auto_God_Human,function(value)
...
if World3 then
   Race:Seperator("Full Mon VaÌ€ ÄaÌ‰o BiÌ Ã‚Ì‰n")
	...
	while task.wait() do
		pcall(function()
			if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
				mr:Set("ðŸ Check Mirage : CoÌ âœ…")
			else
				mr:Set("ðŸ Check Mirage : KhÃ´ng CoÌ âŒ")
			end
		end)
	end
end) 
...
if World1 or World2 then
    Race:Label("Qua Sea 3 MÆ¡Ìi BÃ¢Ì£t ÄÆ°Æ¡Ì£c Dcm")
end
...
if World3 then
    ...
    Race:Seperator("HÃ´Ìƒ TrÆ¡Ì£ GaÌ£t CÃ¢Ì€n")
    Race:Toggle("Auto Treo ÄaÌ‰o BiÌ Ã‚Ì‰n",_G.dao,function(state)
    if state then
        _G.dao = true
    else
        _G.dao = false
...
Race:Toggle("NoÌi ChuyÃªÌ£n VÆ¡Ìi ÄaÌ CÃ¢Ìp TÃ´Ìc",false,function(value)
local DiscordLib = {}
	local TweenService = game:GetService("TweenService")
	local Balaraja = Instance.new("ScreenGui")
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
DiscordLib:Notification("ThÃ´ng BÃ¡o" , "HoaÌ€n TÃ¢Ìt" , 10 ,11816162894 )
end)




Race:Toggle("Ã”ng BaÌn Fruit Mirage",false,function(value)
    FindAdvancedDealer()
end)
...
Race:Toggle("NhiÌ€n TrÄƒng",false,function(value)
    _G.LockMoon = value
end)

Race:Toggle("Bay VÃ´ ÄaÌ‰o BiÌ Ã‚Ì‰n",false,function(value)
    _G.mirage = value
end)
...
Race:Button("NhÄƒÌ£t Gear",function()
    ...
    if v.Name:find("Part") and v.ClassName == "MeshPart" then
        ...
        Race:Button("LuÌ£m Chest ÄaÌ‰o BiÌ Ã‚Ì‰n",function()
    ...
    Race:Button("XoÌa SÆ°Æ¡ng MuÌ€",function()
    game:GetService("Lighting").BaseAtmosphere:Destroy()
    end)
...
Race:Seperator("Teleport TÃ´Ì£c V4")

Race:Button("DiÌ£ch ChuyÃªÌ‰n ÄÃªÌn CÃ´Ì‰ng TÃ´Ì£c CuÌ‰a BaÌ‰n ThÃ¢n",function()
 ...
 Race:Button("DiÌ£ch ChuyÃªÌ‰n ÄÃªÌn ChÃ´Ìƒ GÄƒÌn Gear",function()
for _,v in next, workspace:GetDescendants() do
 ...
 Race:Seperator("Auto Win AÌ‰i V4")
  Race:Toggle("Win AÌ‰i All TÃ´Ì£c",_G.winv4,function(value)
 _G.winv4 = value
 StopTween(_G.winv4)
end)
spawn(function()
...
Race:Toggle("ÄaÌnh Sea Beasts TÃ´Ì£c CaÌ",_G.SeaBeasts1,function(value)
 _G.SeaBeasts1 = value
 StopTween(_G.SeaBeasts1)
end)
...
function fireremotechoosegear(bH)
   ...
   DiscordLib:Notification("ThÃ´ng BÃ¡o" , "ChoÌ£n Gear Äi BeÌ" , 6 ,1181616289)
end
function InstantChooseGear()
    ...
    if v14 and v14.HadPoint then
        ...
        task.wait(300)
        	...
        	DiscordLib:Notification("ThÃ´ng BÃ¡o" , "Chx up gear" , 6 ,1181616289)
        task.wait(30)
    end
end


Race:Toggle("Auto GÄƒÌn Gear",false,function(value)
 _G.gear = value
 StopTween( _G.gear)
end)
...
Race:Seperator("Buy + BÃ¢Ì£t TÃ´Ì£c") 
 
   Race:Toggle("Kill NgÆ°Æ¡Ì€i ChÆ¡i ( 90% Win )",_G.killplayertrain,function(value)
 ...
 StopTween(_G.killplayertrain)
   ...
   Race:Toggle("TÆ°Ì£ ÄÃ´Ì£ng BÃ¢Ì£t V4",_G.Auto_Farm_Bone3,function(value)
  _G.V4 = value
  StopTween(_G.V4)
   end)
...
Race:Button("DiÌ£ch ChuyÃªÌ‰n ÄÃªÌn Npc Mua Train",function()
    Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
...
Playerslist = {}
    ...
    local SelectedPly = P:Dropdown("ChoÌ£n NgÆ°Æ¡Ì€i ChÆ¡i",Playerslist,function(value)
        _G.Select_Player = value
    end)
    
    P:Button("ÄÄƒÌ£t LaÌ£i Player ÄaÌƒ ChoÌ£n",function()
        Playerslist = {}
        SelectedPly:Clear()
        for i,v in pairs(game:GetService("Players"):GetChildren()) do  
...
P:Toggle("Theo DoÌƒi Player",_G.Spectate_Player,function(value)
...
P:Toggle("Bay Ä‘ÃªÌn Player",_G.Teleport_to_Player,function(value)
...
P:Toggle("Kill NgÆ°Æ¡Ì€i ChÆ¡i = Mele",_G.Auto_Kill_Player_Melee,function(value)
...
P:Toggle("Kill NgÆ°Æ¡Ì€i ChÆ¡i = SuÌng",_G.Auto_Kill_Player_Gun,function(value)
...
P:Slider("Kick ThÆ°Æ¡Ìc VoÌ€ng Aim",1,1000,200,function(value)
 _G.Select_Size_Fov = value
end)
P:Toggle("HiÃªÌ£n VoÌ€ng",_G.Show_Fov,function(value)
 _G.Show_Fov = value and _G.Select_Size_Fov == 200
StopTween(_G.Show_Fov)
end)
 
P:Toggle("Aim Skill Trong VoÌ€ng",_G.Aimbot_Skill_Fov,function(value)
...
StopTween(_G.Aimbot_Skill_Fov)
 ...
 Teleport:Dropdown("Select Island", {
  ...
  "NÃºi Tuyáº¿t",
  "Äáº£o Raid",
  "Con tÃ u bá»‹ nguyá»n rá»§a",
  "LÃ¢u Ä‘Ã i bÄƒng",
  "Äáº£o cuá»‘i Sea2",
  "Äáº£o Usopp",
  "Äáº£o Láº¥y Gáº­y LÃ´i v2"
 },function(value)
  _G.SelectIsland = value
  end)
 end
 ...
 Teleport:Dropdown("Select Island", {
  "CaÌ‰ng",
  "Dinh ThÆ°Ì£ ( ÄaÌ‰o RuÌ€a )",
  "CÃ¢y Ä‘áº¡i thá»¥",
  "PhaÌo ÄaÌ€i Biá»ƒn",
  "ÄaÌ‰o PhuÌ£ Ná»¯",
  "ÄaÌ‰o XÆ°Æ¡ng",
  "Äáº£o Kem",
 ...
 Teleport:Toggle("Teleport",false,function(value)
  ...
  elseif _G.SelectIsland == "Äáº£o Háº£i QuÃ¢n" then
  topos(CFrame.new(-2566.4296875, 6.8556680679321, 2045.2561035156))
  elseif _G.SelectIsland == "Äáº£o Trung TÃ¢m" then
  topos(CFrame.new(-690.33081054688, 15.09425163269, 1582.2380371094))
  elseif _G.SelectIsland == "Rá»«ng" then
  topos(CFrame.new(-1612.7957763672, 36.852081298828, 149.12843322754))
  elseif _G.SelectIsland == "Äáº£o ChÃºa Há»" then
  ...
  elseif _G.SelectIsland == "CÄƒng Cá»© Háº£i QuÃ¢n" then
  topos(CFrame.new(-4914.8212890625, 50.963626861572, 4281.0278320313))
  elseif _G.SelectIsland == "Äáº¥u trÆ°á»ng La MÃ£" then
  ...
  elseif _G.SelectIsland == "NhÃ  Ngá»¥c" then
  topos(CFrame.new(4875.330078125, 5.6519818305969, 734.85021972656))
  elseif _G.SelectIsland == "Äáº£o Dung Nham" then
  topos(CFrame.new(-5247.7163085938, 12.883934020996, 8504.96875))
  elseif _G.SelectIsland == "Äáº£o NgÆ°á»i CÃ¡" then
  ...
  elseif _G.SelectIsland == "CÃ  phÃª" then
  topos(CFrame.new(-380.47927856445, 77.220390319824, 255.82550048828))
  elseif _G.SelectIsland == "Äáº£o Äáº§u TiÃªn" then
  topos(CFrame.new(-11.311455726624, 29.276733398438, 2771.5224609375))
  elseif _G.SelectIsland == "Äáº£o RÃ¢u Äen" then
  topos(CFrame.new(3780.0302734375, 22.652164459229, -3498.5859375))
  elseif _G.SelectIsland == "Cá»•ng VÃ o Flamingo" then
  topos(CFrame.new(-483.73370361328, 332.0383605957, 595.32708740234))
  elseif _G.SelectIsland == "PhÃ²ng Flamingo" then
  topos(CFrame.new(2284.4140625, 15.152037620544, 875.72534179688))
  elseif _G.SelectIsland == "VÃ¹ng xanh" then
  topos(CFrame.new(-2448.5300292969, 73.016105651855, -3210.6306152344))
  elseif _G.SelectIsland == "NhÃ  mÃ¡y" then
  topos(CFrame.new(424.12698364258, 211.16171264648, -427.54049682617))
  elseif _G.SelectIsland == "Äáº¥u trÆ°á»ng" then
  topos(CFrame.new(-1503.6224365234, 219.7956237793, 1369.3101806641))
  elseif _G.SelectIsland == "Äáº£o Zombie" then
  topos(CFrame.new(-5622.033203125, 492.19604492188, -781.78552246094))
  elseif _G.SelectIsland == "NÃºi Tuyáº¿t" then
  topos(CFrame.new(753.14288330078, 408.23559570313, -5274.6147460938))
  elseif _G.SelectIsland == "Äáº£o Raid" then
  topos(CFrame.new(-6127.654296875, 15.951762199402, -5040.2861328125))
  elseif _G.SelectIsland == "Con tÃ u bá»‹ nguyá»n rá»§a" then
  topos(CFrame.new(923.40197753906, 125.05712890625, 32885.875))
  elseif _G.SelectIsland == "LÃ¢u Ä‘Ã i bÄƒng" then
  ...
  elseif _G.SelectIsland == "Äáº£o Láº¥y Gáº­y LÃ´i v2" then
  topos(CFrame.new(-288.74060058594, 49326.31640625, -35248.59375))
  elseif _G.SelectIsland == "CÃ¢y Ä‘áº¡i thá»¥" then
  topos(CFrame.new(2681.2736816406, 1682.8092041016, -7190.9853515625))
  elseif _G.SelectIsland == "PhaÌo ÄaÌ€i Biá»ƒn" then
  ...
  elseif _G.SelectIsland == "CaÌ‰ng" then
  topos(CFrame.new(-290.7376708984375, 6.729952812194824, 5343.5537109375))
  elseif _G.SelectIsland == "ÄaÌ‰o PhuÌ£ Ná»¯" then
  topos(CFrame.new(5228.8842773438, 604.23400878906, 345.0400390625))
  elseif _G.SelectIsland == "Dinh ThÆ°Ì£ ( ÄaÌ‰o RuÌ€a )" then
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-12471.169921875, 374.94024658203, -7551.677734375))
  elseif _G.SelectIsland == "ÄaÌ‰o XÆ°Æ¡ng" then
  ...
  elseif _G.SelectIsland == "Äáº£o BÃ¡nh" then
...
Teleport:Button("VÃ´ LaÌ£i Sever",function()
 local ts = game:GetService("TeleportService")
		local p = game:GetService("Players").LocalPlayer
		ts:Teleport(game.PlaceId, p)
end)

Teleport:Button("ÄÃ´Ì‰i Sever",function()
 hop()
end)
    Teleport:Button("ÄÃ´Ì‰i Sever iÌt NgÆ°Æ¡Ì€i",function()
...
Dungeon:Dropdown("Chip CÃ¢Ì€n Mua",chip,function(value)
...
Dungeon:Toggle("Auto LÃ¢Ìy Fruit DÆ°Æ¡Ìi 1M",_G.Autofruit,function(value)
 _G.Autofruit = value
end)
spawn(function()
    while wait(.1) do
...
Dungeon:Toggle("Start + kill + Qua ÄaÌ‰o",_G.Auto_StartRaid,function(value)
...
Dungeon:Toggle("Treo TiÃªÌ€n F",_G.Autofruit,function(value)
 _G.Autofruit = value
 _G.Kill_Aura = value
 _G.Auto_Next_Island = value
 _G.Auto_Buy_Chips_Dungeon = value
...
Dungeon:Toggle("TÆ°Ì£ ÄÃ´Ì£ng ThÆ°Ìc TiÌ‰nh",_G.Auto_Awake,function(value)
 _G.Auto_Awake = value 
end)
...
Dungeon:Button("Check ThÆ°Ìc TiÌ‰nh",function()
       pcall(function()
  ...
  Dungeon:Button("Qua ÄaÌ‰o TiÃªÌp Theo",function()
   pcall(function()
    if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
    topos(game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5").CFrame*CFrame.new(0,70,100))
    elseif game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 4") then
...
Dungeon:Toggle("BÄƒÌt ÄÃ¢Ì€u Raid Law ",_G.Auto_Start_Law_Dungeon,function(value)
...
spawn(function()
 ...
 DevilFruit:Seperator(" Khi BaÌn ")
 ...
 _G.SelectFruit = ""
 DevilFruit:Dropdown("ChoÌ£n Fruit",FruitList,function(value)
 ...
 DevilFruit:Dropdown("ChoÌ£n Fruit ÄÃªÌ‰ Ä‚n",FruitList,function(value)
  _G.SelectFruitEat = value
  end)
 
 DevilFruit:Toggle("Ä‚n Fruit ÄaÌƒ ChoÌ£n",_G.AutoEatFruit,function(value)
 ...
 DevilFruit:Toggle("TÆ°Ì£ ÄÃ´Ì£ng Quay Fruit",_G.Random_Auto,function(value)
 ...
 spawn(function()
  ...
  DevilFruit:Button("TÄƒng NhÃ¢n PhÃ¢Ì‰m Quay Fruit",function()
      local DiscordLib = {}
	local TweenService = game:GetService("TweenService")
	local Balaraja = Instance.new("ScreenGui")
...
DiscordLib:Notification("ThÃ´ng BÃ¡o" , "NhÃ¢n PhÃ¢Ì‰m ÄaÌƒ LÃªn 1000%" , 10 ,11816162894 )
  end)
 ...
 DevilFruit:Toggle("TÆ°Ì£ ÄÃ´Ì£ng VÃ¢Ìt Fruit",_G.DropFruit,function(value)
  _G.DropFruit = value
  end)
 ...
 DevilFruit:Toggle("TÆ°Ì£ ÄÃ´Ì£ng CÃ¢Ìt Fruit",_G.AutoStoreFruit,function(value)
...
spawn(function()
 ...
 DevilFruit:Toggle("Tele Fruit BoÌ£n NoÌ VÃ¢Ìt Ra",_G.BringFruit,function(value)
  _G.BringFruit = value
  pcall(function()
 ...
 DevilFruit:Toggle("LuÌ£m Fruit Spawm",false,function(value)
 _G.Grabfruit = value
end)
            ...
            if IslandESP then
                if v.Name ~= "NeonShrinePart" then
                    if not v:FindFirstChild('IslandESP') then
                        ...
                        -- Thay Ä‘á»•i vÄƒn báº£n hiá»ƒn thá»‹ thÃ nh "123"
...
if World2 then
		DevilFruit:Button("Tp Hoa ÄoÌ‰",function()
			for i,v in pairs(game.Workspace:GetDescendants()) do
				if v.Name == "Flower2" then
				    topos(v.CFrame)
				end
	...
	DevilFruit:Toggle("ESP NgÆ°Æ¡Ì€i ChÆ¡i",false,function(a)
		ESPPlayer = a
	...
	DevilFruit:Toggle("ESP TrÃ¡i Ã¡c quá»·",false,function(a)
		DevilFruitESP = a
...
Shop:Dropdown("ChoÌ£n Item Buy",{
  "MuÌƒ yÃªu tinh ( 250 Candies )",
  "MuÌƒ santa ( 500 Candies )",
  "Xe trÆ°Æ¡Ì£t tuyÃªÌt ( 1000 Candies )"
 },function(value)
  _G.buyitem = value
 end)

 Shop:Toggle("Mua Item GiÃ¡ng sinh",false,function(value)
  _G.buyitemevent = value
  if _G.buyitemevent == true then
  repeat wait()
  if _G.buyitem == "MuÌƒ yÃªu tinh ( 250 Candies )" then
  local args = {
    [1] = "Candies",
    [2] = "Buy",
    [3] = 3,
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
  elseif _G.buyitem == "MuÌƒ santa ( 500 Candies )" then
local args = {
    [1] = "Candies",
    [2] = "Buy",
    [3] = 3,
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
  elseif _G.buyitem == "Xe trÆ°Æ¡Ì£t tuyÃªÌt ( 1000 Candies )" then
local args = {
    [1] = "Candies",
    [2] = "Buy",
    [3] = 3,
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
   ...
   Shop:Button("HoaÌ€n chiÌ‰ sÃ´Ì ( 75 Candies )",function()
local args = {
    [1] = "Candies",
    [2] = "Buy",
    [3] = 1,
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
     ...
     Shop:Button("Thay Ä‘Ã´Ì‰i chuÌ‰ng tÃ´Ì£c ( 100 Candies )",function()
local args = {
    [1] = "Candies",
    [2] = "Buy",
    [3] = 1,
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
 ...
 Shop:Button("ÄÃ´Ì‰i TÃ´Ì£c ( 3K F )",function()
  -- Script generated by SimpleSpy - credits to exx#9394
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
 ...
 Shop:Button("Mua TÃ´Ì£c QuÌ‰y",function()
local args = {
    [1] = "Ectoplasm",
    [2] = "BuyCheck",
    [3] = 4
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
 ...
 Shop:Button("Mua TÃ´Ì£c MaÌy",function()
local args = {
    [1] = "CyborgTrainer",
    [2] = "Check"
}
...
Misc:Button("Danh HiÃªÌ£u",function()
 local args = {
			[1] = "getTitles"
		}
		game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
Misc:Button("MaÌ€u Haki",function()
...
local x2Code = {
 ...
 "Enyu_is_Pro"
    ...
    Misc:Button("NhÃ¢Ì£p All Codes",function()
...
Misc:Seperator(" Player Misc ")
    ...
    Misc:Button("BoÌ£c Haki",function()
        if _G.SelectStateHaki == "BaÌ€n Tay" then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ChangeBusoStage",0)
        elseif _G.SelectStateHaki == "Full Tay" then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ChangeBusoStage",1)
        elseif _G.SelectStateHaki == "Full Tay VaÌ€ NÆ°Ì‰a ThÃ¢n" then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ChangeBusoStage",2)
        elseif _G.SelectStateHaki == "Full Tay VaÌ€ ThÃ¢n" then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ChangeBusoStage",3)
        elseif _G.SelectStateHaki == "Full ThÃ¢n vaÌ€ Tay " then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ChangeBusoStage",4)
        elseif _G.SelectStateHaki == "FUll NgÆ°Æ¡Ì€i" then
...
--Misc:Toggle("Dodge No Cooldown",false,function(value)
  ...
  --  end)
    ...
    Misc:Toggle("TÆ°Ì£ ÄÃ´Ì£ng BÃ¢Ì£t TÃ´Ì£c v3",_G.AutoAgility,function(value)
    ...
    spawn(function()
     ...
     Misc:Toggle("ChaÌ£y Nhanh",true,function(value)
        InfAbility = value
        if value == false then
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility"):Destroy()
        end
    ...
    Misc:Toggle("TÄƒng PhaÌ£m Vi Haki Quan SaÌt",getgenv().InfiniteObRange,function(value)
  ...
  --  end)
    ...
    Misc:Toggle("Soru VÃ´ HaÌ£n",getgenv().InfSoru,function(value)
    ...
    Misc:Toggle("ÄÆ°Ìng TrÃªn BiÃªÌ‰n",true,function(value)
        _G.WalkWater = value
    end)
    
    if World2 then
		Misc:Button("XoÌa Lava",function()
			for i,v in pairs(game.Workspace:GetDescendants()) do
				if v.Name == "Lava" then   
					v:Destroy()
				end
...
spawn(function()
 ...
 --   end)
    ...
    --Misc:Button("Unlock FPS",function()
       -- setfpscap(100)
  --  end)
Misc:Button("TaÌ€n HiÌ€nh",function()
...
TextButton.Text = "Click NÃªÌu CoÌ MaÌ‰nh GÆ°Æ¡ng"
...
Left.Size = UDim2.new(.5,0,1,0) --HAÌ€NG
tvk.Parent = Left

local Right = Instance.new("Frame",game.Players.LocalPlayer.PlayerGui.BubbleChat)
Right.BackgroundTransparency = 1
Right.Size = UDim2.new(.5,0,1,0)   -- HAÌ€NG FRUIT
...
for k,v in pairs(allitem) do 
    ...
    tvk.CellPadding = UDim2.new(.005,0,.0) -- KHOAÌ‰NG CAÌCH NGANG
    tvk.CellSize =  UDim2.new(0,56,0,56) -- to nhoÌ‰
...
for k,v in pairs(allitem) do 
    ...
    tvk.CellSize =  UDim2.new(0,33,0,33) -- to nhoÌ‰
    tvk.FillDirectionMaxCells = 100
    tvk.FillDirection = Enum.FillDirection.Horizontal
